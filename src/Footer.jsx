...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.148-1.192S4.109 14.297 4.109 13s.49-2.448 1.192-3.148S6.8 8.66 8.097 8.66s2.448.49 3.148 1.192.1192 1.499 1.192 2.796-.49 2.448-1.192 3.148S9.746 16.988 8.449 16.988z"/>
        </svg>
      )
    },
    {
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex w-full md:w-auto">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-r-lg font-semibold transition-colors duration-200"
              >
                Subscribe
              </button>
            </div>
